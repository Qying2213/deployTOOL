...
export function build(config, { skipTests = false } = {}) {
  ...
  const manifest = { schema_version: 1, release_id: id, source_sha256: sourceSha, environment: config.environment, ...gitState, built_at: new Date().toISOString(), source_file_count: list.length, tool: { admin_backend_release_tool: production ? '5' : '1' } }
